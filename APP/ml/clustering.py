...
print(get_patient_by_sub_id(df_std_cluster, 10006))
print(get_patient_info(df_std_cluster, 10006))


subject_id = st.subject_id_input('Inserte el id del paciente')
st.write('El id de paciente seleccionado es ', subject_id)
